		...
		<table class="table table-bordered table-striped">
			...
			<tr>
				...
				<td class="text-center action">
				    <a class="popinfo" data-container="body" data-toggle="popover" data-placement="left" data-content="{{ _('SIP Username : ').Config::get('settings.global_prefix').Domain::find(Auth::user()->domain_id)->prefix.$phone_number->extension }}<br>{{ _('SIP Password : ******') }}<br>{{ _('SIP Domain : ').Domain::find(Cookie::get('domain_hash'))->domain }}<br>{{ _('SIP Server : ').Config::get('settings.sip_server') }}"><span class="glyphicon glyphicon-info-sign"></span></a>
